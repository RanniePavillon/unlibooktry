...
function data() {
    ...
    $data = '
			...
			<table class="tbleInvoice" style="cellpadding:1px;" >
				<tr class="invoicetr">
					<td style="width:390px; font-size:12px; height:18px;">Client Name: ' . $client->clientName . '</td>
					<td style="height:18px;width:130px;">Billing No.:</td>
				...
				<tr class="invoicetr">
					<td style="width:390px; height:18px;">Address: ' . $client->address . '</td>
					<td style="width:130px;height:18px;">Billing Date:</td>
				...
				<tr class="invoicetr">	
					<td class="particularInvoice" style="width:390px;height:18px;"></td>
					<td style="width:130px;height:18px;">Ref No.:</td>
					<td>' . $invoice->pOSO . '</td>
					<td></td>
					<td></td>
					<td></td>
				...
				<tr class="invoicetr">	
					<td class="particularInvoice" style="width:390px;height:18px;"></td>
					<td style="width:130px;height:18px;">Discount ' . ($invoice->discount > 0 ? 'In percent:' : 'In amount:' ) . '</td>
    ...
    if (count($taskline) > 0) {
        $data .= '<div style="margin-top:50px;" height=12px></div>' .
    ...
    $data .= '<br/>' .
            ...
            '<table cellpadding="4";>' .
            '<tr>' .
            '<td class="" style="font-size:12px;height:18px;width:339px; border:none;" cellpadding="4";></td>' .
            ...
            '</tr>' .
            '<tr>' .
            '<td style="font-size:12px;" width="390">"THIS DOCUMENT IS NOT VALID FOR CLAIMING INPUT TAXES"</td>' .
