...
<div class="prevColMainHolder" style="margin-top:100px !important;">
	<div class="printPrevHolder">
		...
		<div style="margin-top:30px;">
			<div class="leftSideOR hiddens">
				<table class="tblORvatLeftSide hiddens">
					...
					<tr>
						<th  class="lightGrayTD"><?= $data['cas_no'] ? $data['cas_no'] : $data['ref_num']?></th>
					...
					<tr>
						...
						<th class="lightBlueTD borderThick blueGrayWidth">
							...
							//$grandTotalArray = explode('.', Controller::getFloat($invoiceamount->grandTotal));
							//echo $grandTotalArray[0];
							$total = $this->invoiceamount->grandTotal;
							$invoiceamountArray = explode('.', Controller::getFloat($total));
					...
					<tr>
						...
						<th class="lightGrayTD blueGrayWidth2">
							<?php echo $invoiceamountArray[1]; ?>
						</th>
					</tr>
					<tr>
						...
						<th class="lightBlueTD blueGrayWidth">
							...
							//$grandTotalArray = explode('.', Controller::getFloat($invoiceamount->grandTotal));
							//echo $grandTotalArray[0];
							//$wht = ($data['amount_received'] - $data['amount_received']);
							$total = $this->invoiceamount->grandTotal;
							$invoiceamountArray = explode('.', Controller::getFloat($total));
							echo $invoiceamountArray[0];
							?>
		...
		<div class="rightSideOR">
			...
			<div style="text-indent:20px;margin-top:20px;">
					<label class="hideText">Received from</label> <input type="text" class="inputUnderline lineWidth1 withMarginLeft1" value="<?= ucwords($data['client_name']) ?>" readonly>
					<label class="hideText">with TIN</label> <input type="text" class="inputUnderline lineWidth2 withMarginLeft2" value="<?= $data['tin_num'] ?>" readonly> 
					...
					<label class="hideText">(&#8369;</label> <input type="text" class="inputUnderline lineWidth6 withMarginLeft6" value="<?= Controller::getFloat($this->invoiceamount->grandTotal) ?>"><label class="hideText">).</label> 
					<label class="hideText">In <?php echo $partial ?>/<?php echo $full ?> payment for</label> <input type="text" class="inputUnderline lineWidth7 withMarginLeft7"
						value="<?= implode(',', $invoices) ?>" readonly><label class="hideText">.</label>
			</div>
