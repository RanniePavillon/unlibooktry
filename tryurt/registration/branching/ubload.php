<html>
	<head>
		<style>
			body{
				...
				/* padding: 0;
				margin: 0;
				background: url('http://meds.unlibooks.com/public/images/loginback.png') no-repeat white;
	...
	<body>
		<div class="MainHolder">
			<div class="MainHeader">Please wait while we <br/>configure outlet account.</div>
			<div class="Loading">
