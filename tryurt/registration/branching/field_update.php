...
//	';
	...
	if ($conn->connect_error) {
        ...
        $result = $conn->query("SHOW COLUMNS FROM `tbl_user_level` LIKE 'BIR';");
...
//	$filename = "../unlibooks.com/databases/generate_trading_database_new.sql";
        $filename = SERVERTYPE =='local' ? "../unlibooks.com/databases/trading/db_parts/field_update.sql" : DBFIELD_UPDATE;
