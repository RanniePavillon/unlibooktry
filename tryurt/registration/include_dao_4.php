<?php
	...
	require_once('registration/class/dao/MainContactMessagesDAO.class.php');
	require_once('registration/class/dto/MainContactMessage.class.php');
	require_once('registration/class/mysql/MainContactMessagesMySqlDAO.class.php');
	require_once('registration/class/mysql/ext/MainContactMessagesMySqlExtDAO.class.php');
