    ...
    <form method='post' action='<?php echo URL ?>invoice/invoices?page=<?= $page ?>&ipp=<?= $ipp ?>' id='form'>
        <div class="invoiceHolderInvoice">
            <div id="newInvoice" class="headings">
                <label class="headText">ALL TRANSFER OF STOCKS</label>
                <?php if ($useraccess->Add == 'yes') { ?>
                    <a href="<?php echo URL ?>">	
                        <!-- <label class="crossTransfer"> -->
                            <input type="button" class="createTOS buttonslarge" value="CREATE NEW TRANSFER">
                            </a>
                        <?php } ?>
            </div>	
                ...
                <div class="center2">
                    <div id="search3" style="float:left;margin-top:9px;">
                        <?php if ($useraccess->Edit == 'yes') { ?>
                            <input type="button" name="edit" value="EDIT" class="delete1 buttonHover buttoninvoices" id="edit" onclick="editrec('', 'edit')">
                    ...
                    <div style="float:right;margin-right:30px;margin-top:4px;">
                        ...
                        <label class="labelclass">
                            <select class="inumber" name="searchby" id="searchby">
                                <option class="invNoOption" value="1" <?php echo ($searchby == 1) ? 'selected' : '' ?>>TS NO.</option>
                            </select>
                        </label>
                        ...
                        <input type="submit" name="search2" value="" class="search2Col <?php // echo ($searchby != 3) ? 'hidden' : ''        ?>" style="margin-left:331px;">
                    </div>
                    <div style="clear:both;"></div>
                </div>
        ...
        <div class="moduleHeight">
            ...
            <table class="cnitableAllInvoice">
                <tr class="cnitableAllInvoiceTr" id="hoverTr">
                    ...
                    <th style="text-align:left;padding:5px;padding-left: 5px;width:11%;"><a onclick="sort('invoice', '<?php echo ($sortdirection == 'desc') ? 'asc' : 'desc' ?>')">Transfer Stock No.</a></th>
                    <th style="text-align:left;padding-left: 5px;width:11%;"><a onclick="sort('date', '<?php echo ($sortdirection == 'desc') ? 'asc' : 'desc' ?>')">Date</a></th>
                    <th style="text-align:left;padding-left: 5px;width:20%;"><a onclick="sort('client', '<?php echo ($sortdirection == 'desc') ? 'asc' : 'desc' ?>')">Transfer From</a></th>
                    <th style="text-align:right;padding-right:0px;width:11%;">Transfer To</th>
                    <th style="text-align:right;padding-right: 5px;width:12%;">Total Qty</th>
                    <th style="text-align:center;padding-right:5px;width:11%;">UOM</th>
                </tr>
                ...
                if ($this->data) {
                    foreach ($this->data as $item) {
                        ...
                        <tr class="tablecni" id="hoverTr">
                            ...
                            <td style="text-align:left;padding-left: 5px;" class=""><a href="#" onclick="editrec(<?php echo $item->id ?>, '')"><?php echo $item->transferNo ?></a></td>
                            <td style="text-align:left;padding-left: 5px;" class=""><?php echo $item->dateIssued ?></td>
                            <td style="text-align:left;padding-left: 5px;" class=""><?php echo DAOFactory::getTblWarehouseDAO()->load($item->fromWarehouse)->warehouseName ?></td>
                            <td style="text-align:right;padding-right: 5px;" class=""><?php echo DAOFactory::getTblWarehouseDAO()->load($item->toWarehouse)->warehouseName ?></td>
                            <td class=""><?php echo $item->totalQty ?></td>
                            <td class="stat"style="text-align:center;padding-right: 5px;"><?php echo $item->abbreviation ?></td>
                        </tr>
        ...
        <table class="cnitableAllInvoice2" style="margin-top:40px;">
            <tr class="cnitableAllInvoice2">
                ...
                <th style="text-align:right;padding-right: 5px;width:12%;font-family:Verdana;font-size:12px;"><?php //echo Controller::getFloat($total);    ?></th>
