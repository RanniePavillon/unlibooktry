...
<style>
    ...
    .createNIItem{
        ...
        height: 32px;
        border: none;
        background-image:url('{{asset('images/salesorder.png')}}');
        background-repeat:no-repeat;
        cursor: pointer;
        border-radius:5px;
    ...
    <form method='post' action="{{('inventory')}}" id='form'>
        <div class="invoiceHolderInvoice">
            <div id="newInvoice" class="headings">
                <label class="headText">ALL BRANCHES</label>
				<!-- </?php if ($useraccess->Add == 'yes') { ?>	 -->
						<a href="{{('')}}">	
							<label class="crossSalesbranch"><input type="button" class="createNLocation createBranch buttonslarge" value="CREATE NEW BRANCH" style="padding-left: 33px;"></label>
						</a>
                ...
                <div style="float:right;margin-right:30px;margin-top:4px;">
					...
					<label class="labelclass">	
						<select class="inumber" name="searchby" id="searchby">
							<option class="invNoOption" value="1">BRANCH NO.</option>
							<option class="invNoOption" value="2">BRANCH Name</option>
						</select>
					</label>
        ...
        <div>
            ...
            <table class="cnitableAllInvoice">
                <tr class="cnitableAllInvoiceTr" id="hoverTr">
                    ...
                    <th style="text-align:left;padding:5px;padding-left: 5px;width:11%;"><a onclick="sort('invoice', '')">Branch No.</a></th>
                    <th style="text-align:left;padding-left: 5px;width:20%;">Branch Name</th>
				...
				?> -->
						<tr class="tablecni" id="hoverTr">
							...
							<td style="text-align:left;padding-left: 5px;" class=""><a href='#'></a></td>
        ...
        <table class="tfootTable">
            <tfoot>
                <tr class="under">
                    <td colspan="5" style="font-family:Verdana;font-size:11px;color:#fff;font-weight:bold;text-align: center" >
