        ...
        <div class="invoiceHolderInvoice">
            <div id="newInvoice" class="headings">
				...
				<?php if ($useraccess->Add == 'yes') { ?>	
						<a href="<?php echo URL ?>">	
							<!-- <label class="crossSaleslocation"> -->
                                <input type="button" class="createNLocation buttonslarge" value="CREATE NEW WAREHOUSE">
                            <!-- </label> -->
						</a>
				<?php } ?>
            </div>	
                ...
                <div style="float:right;margin-right:30px;margin-top:4px;">
					...
					<label class="labelclass">	
						<select class="inumber" name="searchby" id="searchby">
							<option class="invNoOption" value="1" <?php echo ($searchby == 1) ? 'selected' : '' ?>>WAREHOUSE NO.</option>
							<option class="invNoOption" value="2" <?php echo ($searchby == 2) ? 'selected' : '' ?>>WAREHOUSE Name</option>
						</select>
					</label>
        ...
        <div class="moduleHeight">
            ...
            <table class="cnitableAllInvoice">
                <tr class="cnitableAllInvoiceTr" id="hoverTr">
                    ...
                    <th style="text-align:left;padding:5px;padding-left: 5px;width:11%;"><a onclick="sort('invoice', '<?php echo ($sortdirection == 'desc') ? 'asc' : 'desc' ?>')">Warehouse No.</a></th>
                    <th style="text-align:left;padding-left: 5px;width:20%;">Warehouse Name</th>
				...
				?>
						<tr class="tablecni" id="hoverTr">
							...
							<td style="text-align:left;padding-left: 5px;" class=""><?php echo $item->warehouseName ?></td>
                                                        <td style="text-align:left;padding-left: 5px;" class=""><?php echo date('m/d/Y', strtotime($item->dateCreated)) ?></td>
						</tr>
				<?php
					}
				}
