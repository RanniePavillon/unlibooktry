...
<div class="mainbodyInvoice">
    <form method='post' action='<?php echo URL ?>approval?page=<?= $page ?>&ipp=<?= $ipp ?>' id='form'>
        <div class="invoiceHolderInvoice">
            <div id="newInvoice" class="headings">
                <label class="headText">SALES ORDER FOR APPROVAL</label>
            </div>	
        ...
        <div>
            ...
            <table class="cnitableAllInvoice">
                <tr class="cnitableAllInvoiceTr" id="hoverTr">
                    ...
                    <th style="text-align:left;padding:5px;padding-left: 5px;width:11%;"><a onclick="sort('invoice', '<?php echo ($sortdirection == 'desc') ? 'asc' : 'desc' ?>')">SO No.</a></th>
                    ...
                    <th style="text-align:right;padding-right:0px;width:11%;">Date of Delivery</th>
                    <th style="text-align:center;padding-right:5px;width:11%;">Total Quantity</th>
                    <th style="text-align:right;padding-right: 5px;width:12%;">Total Amount</th>
                    <th style="text-align:left;padding-right:5px;width:11%;">Status</th>
                ...
                if ($this->data) {
                    foreach ($this->data as $item) {
                        ...
                        <tr class="tablecni" id="hoverTr">
                            ...
                            <td style="text-align:left;padding-left: 5px;" class=""><a href="#" onclick="editrec(<?php echo $item->id ?>)"><?php echo $item->salesOrderNo ?></a></td>
                            ...
                            <td class=""><?php  ?></td>
                            <td class="stat"style="text-align:center;padding-right: 5px;"><?php echo Controller::getFloat($item->grandTotal) ?></td>
                            <td style="text-align:left;padding-right: 5px;"><?php echo ucfirst($item->status) ?></td>
                        </tr>
                        <?php
                    }
                }
            ...
            <table class="cnitableAllInvoice2" style="margin-top:40px;">
                ...
                <tr class="cnitableAllInvoice2">
                    ...
                    <th style="text-align:center;padding-right:5px;width:11%;"><?php echo Controller::getFloat($total);  ?></th>
