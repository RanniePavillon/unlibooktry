...
@media print{
	#headerHead, .everyFooter, .useof, #accpClickToOpen{
		display:none;
	}
	#newInvoice{
...
if (isset($_POST['invoiceid'])) {
    ...
    foreach (DAOFactory::getTblAllCashInvoiceDAO()->queryByNewCashInvoiceId($_POST['invoiceid']) as $each) {
		...
		$cashSalesInvoice = DAOFactory::getTblCashSalesInvoiceAmountDAO()->queryByCashSalesInvoiceId($invoice->id);
...
?>
<link href="<?= URL ?>views/sales/css/receipt.css" rel="stylesheet" type="text/css">
...
<div class="invoiceHolderInvoicePrint">
    <form class="PaymentTypeFormInvoice" style="padding-bottom:20px;">
		...
		<?php 
			//print_r($client);
		?>
       <div id="newInvoicePrint" style="margin-top:34px!important;">CASH INVOICE</div>
		...
		<div style="float:right;margin-right:30px;">	
			<table class="tbleInvoice2">	
				...
				<tr class="invoicetr">
					<td><div style="">Cash Invoice No.:</div></td>
					<td><div ><?php echo $invoice->cashSalesInvoiceNo; ?></div></td>
				</tr>
				<tr class="invoicetr">
					<td><div style="">Remarks:</div></td>
					<td><div ><?php echo $invoice->remarks; ?></div></td>
				</tr>
        ...
        if (count($taskline) > 0) {
                ...
                <table class="tblInvoice2">
                    <thead>
                        <tr class="newTblInv">
                            ...
                            <th style="width:10%;text-align:center;background:#c8c8c8!important;border:1px solid #000!important;">Unit</th>
							<th style="text-align:left;width:30%;background:#c8c8c8!important;border:1px solid #000!important;">Particular</th>
            ...
            <table class="tbl3Invoice2">
				<tr class="">
                    ...
                    <td>
						<input type="text" readonly="readonly" value="<?php
                                ...
                                echo Controller::getFloat($invoiceamount->grandTotal); ?>" class="inputTotalInvoice numeric"/>
					</td>
                </tr>
				<tr class="">
                    ...
                    <td>
						<input type="text" readonly="readonly" value="<?php
                                ...
                                echo Controller::getFloat($invoiceamount->vatAmount); ?>" class="inputTotalInvoice numeric"/>
					</td>
                </tr>
				<tr class="">
                    ...
                    <td>
						<input type="text" readonly="readonly" value="<?php
                                ...
                                echo Controller::getFloat($invoiceamount->grandTotal - $invoiceamount->vatAmount); ?>" class="inputTotalInvoice numeric"/>
					</td>
                </tr>
				<tr class="">
                    <td class="SAInvoice">Less:SC/PWD Discount:</td>
                    <td>
						<input type="text" readonly="readonly" value="" class="inputTotalInvoice numeric"/>
					</td>
                </tr>
				<tr class="">
				...
				<tr class="">
                    <td class="SAInvoice" style="font-weight:bold;">Total Amount Due:</td>
                    <td>
						<input type="text" readonly="readonly" value="<?php
                                //$invoiceamountArray = explode('.', Controller::getFloat($invoiceamount->grandTotal));
                                echo Controller::getFloat($invoiceamount->grandTotal); ?>" class="inputTotalInvoice numeric" style="font-weight:bold;"/>
					</td>
                </tr>
...
<script>
	function viewpdf(invoiceid) {
        window.open(URL + 'sales/pdfview?cashinvoiceid='+invoiceid) 
