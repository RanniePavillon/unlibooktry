...
<div class="mainbodyInvoice footerHeight">
    <form method='post' action='<?php echo URL ?>sales/cm?page=<?= $page ?>&ipp=<?= $ipp ?>' id='form'>
        <div class="invoiceHolderInvoice">
            <div id="newInvoice" class="headings">
                <label class="headText">ALL CM</label>
                <?php if ($useraccess->Add == 'yes') { ?>
                    <a href="<?php echo URL ?>sales/newCm">	
                        <!-- <label class="crossCm"> -->
                            <input type="button" class="createNI buttonslarge" value="CREATE NEW CM">
                            </a>
                        <?php } ?>
                        </div>	
                            ...
                            <div style="float:right;margin-right:30px;margin-top:4px;">
                                ...
                                <label class="labelclass">
                                    <select class="inumber" name="searchby" id="searchby">
                                        <option class="invNoOption" value="1" <?php echo ($searchby == 1) ? 'selected' : '' ?>>CM NO.</option>
                        ...
                        <div class="moduleHeight">
                            ...
                            <table class="cnitableAllInvoice">
                                <tr class="cnitableAllInvoiceTr" id="hoverTr">
                                    ...
                                    <th style="text-align:left;padding:5px;padding-left: 5px;width:11%;">CM No.</th>
                                    <th style="text-align:left;padding-left: 5px;width:11%;">Date</th>
                                    <th style="text-align:left;padding-left: 5px;width:20%;">Customer Name</th>
                                    <th style="text-align:right;padding-right: 5px;width:12%;">Amount</th>
                                    <th style="text-align:center;padding-right: 5px;width:12%;">Status</th>
                                    <th style="text-align:center;padding-right: 5px;width:12%;">Date Reversed</th>
                                </tr>
                                <?php
                                $total = 0;
                                if ($this->data) {
                                    foreach ($this->data as $item) {
                                        ...
                                        <tr class="tablecni" id="hoverTr">
                                            ...
                                            <td style="text-align:left;padding-left: 5px;" class=""><a onclick="editrec(<?php echo $item->id ?>)"><?php echo $item->cmNo ?></a></td>
                                            <td style="text-align:left;padding-left: 5px;" class=""><?php echo $item->dateIssued == '0000-00-00' ? '' : date('m/d/Y', strtotime($item->dateIssued)) ?></td>
                                            ...
                                            <td class="stat"style="text-align:center;padding-right: 5px;"><?php echo $item->dateReversed == '0000-00-00' ? '' : date('m/d/Y', strtotime($item->dateReversed)) ?></td>
                                        </tr>
                                        <?php
                                    }
                                }
