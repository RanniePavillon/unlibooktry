...
<div class="mainbodyInvoice footerHeight">
    <form method='post' action='<?php echo URL ?>sales/salesReturn?page=<?= $page ?>&ipp=<?= $ipp ?>' id='form'>
        <div class="invoiceHolderInvoice">
            <div id="newInvoice" class="headings">
                <label class="headText">ALL SALES RETURNS</label>
				 <?php if ($useraccess->Add == 'yes') { ?>
                    <a href="<?php echo URL ?>sales/newSalesReturn">	
                         <!-- <label class="crossSalesReturn"> -->
                            <input type="button" class="createNI buttonslarge" value="CREATE NEW SALES RETURN">
                      <!--   </label> -->
                    </a>
            <?php } ?>
            </div>	
                ...
                <div style="float:right;margin-right:30px;margin-top:4px;">
					...
					<label class="labelclass">
						<select class="inumber" name="searchby" id="searchby">
							<option class="invNoOption" value="1" <?php echo ($searchby == 1) ? 'selected' : '' ?>>SR NO.</option>
        ...
        <div class="moduleHeight">
            ...
            <table class="cnitableAllInvoice">
                <tr class="cnitableAllInvoiceTr" id="hoverTr">
                    ...
                    <th style="text-align:left;padding:5px;padding-left: 5px;width:11%;"><a onclick="sort('invoice', '<?php echo ($sortdirection == 'desc') ? 'asc' : 'desc' ?>')">SR No.</a></th>
				...
				<tr class="tablecni" id="hoverTr">
					...
					<td style="text-align:left;padding-left: 5px;" class=""><a onclick="editrec(<?php echo $item->id ?>)"><?php echo $item->salesReturnNo ?></a></td>
...
echo "Page ".$this->pages->current_page ." of " . $pages->num_pages;
?>
                    </td>
                </tr>
            </tfoot>
