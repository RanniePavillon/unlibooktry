...
@media print{
	#headerHead, .everyFooter, #accpClickToOpen, .regcontainer {
		display:none;
	}
	#newInvoice{
...
?>
<link href="<?= URL ?>views/sales/css/sales_order.css" rel="stylesheet" type="text/css">
...
<div class="invoiceHolderInvoicePrint">
    <form class="PaymentTypeFormInvoice" style="padding-bottom:20px;">
       ...
       <div id="newInvoicePrint" style="margin-top:34px!important;">SALES ORDER</div>
                ...
                <table class="tblInvoice2">
                    <thead>
                        <tr class="newTblInv">
                            ...
                            <th style="width:10%;text-align:left;background:#c8c8c8!important;border:1px solid #000!important;">Unit</th>
							<th style="text-align:center;width:30%;background:#c8c8c8!important;border:1px solid #000!important;">Particular</th>
		...
		<?php } else { ?>
			<div class="regcontainer" style="font-family:Verdana;font-size:12px;margin-left: 15px;">
