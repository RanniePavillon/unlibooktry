...
<div class="mainbodyInvoice footerHeight">
    <form method='post' action='<?php echo URL ?>sales/deliveryReceipt?page=<?= $page ?>&ipp=<?= $ipp ?>' id='form'>
        <div class="invoiceHolderInvoice">
            <div id="newInvoice" class="headings">
                <label class="headText">ALL DELIVERY RECEIPT</label>
                <?php if ($useraccess->Add == 'yes') { ?>
                    <a href="<?php echo URL ?>sales/newDeliveryReceipt">	
                        <!-- <label class="crossSalesInvoiceDelivery"> -->
                            <input type="button" class="createNI buttonslarge" value="CREATE NEW DELIVERY">
                        <!-- </label> -->
                    </a>
                <?php } ?>
            </div>	
        ...
        <div class="moduleHeight">
            ...
            <table class="cnitableAllInvoice">
                <tr class="cnitableAllInvoiceTr" id="hoverTr">
                    ...
                    <th style="text-align:left;padding:5px;padding-left: 5px;width:11%;"><a onclick="sort('invoice', '<?php echo ($sortdirection == 'desc') ? 'asc' : 'desc' ?>')">DR No.</a></th>
                    ...
                    <th style="text-align:right;padding-right: 5px;width:12%;">DR Amount</th>
                ...
                if ($this->data) {
                    foreach ($this->data as $item) {
                        ...
                        <tr class="tablecni" id="hoverTr">
                            ...
                            <td style="text-align:left;padding-left: 5px;" class=""><a onclick="editrec(<?php echo $item->id ?>)"><?php echo $item->deliveryReceiptNo ?></a></td>
