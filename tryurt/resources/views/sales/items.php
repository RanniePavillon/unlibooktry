    ...
    <form method='post' action='<?php echo URL ?>sales/items?page=<?= $page ?>&ipp=<?= $ipp ?>' id='form'>
        <div class="invoiceHolderInvoice">
            <div id="newInvoice" class="headings">
                <label class="headText">ALL ITEMS</label>
                <?php if ($useraccess->Add == 'yes') { ?>	
                    <a href="<?php echo URL ?>">	
                        <!-- <label class="crossSalesItem"> -->
                            <input type="button" class="createNIItem buttonslarge" value="CREATE NEW ITEM">
                        <!-- </label> -->
                    </a>
                <?php } ?>
            </div>	
        ...
        <div class="moduleHeight">
            ...
            <table class="cnitableAllInvoice">
                <tr class="cnitableAllInvoiceTr" id="hoverTr">
                    ...
                    <th style="text-align:left;padding-left: 5px;width:10%;">UOM</th>
                    <th style="text-align:right;padding-right:0px;width:11%;">Product Type</th>
                    <th style="text-align:right;padding-right: 5px;width:12%;">Purchase Cost</th>
                    <th style="text-align:center;padding-right:5px;width:11%;">Selling Price</th>
                    <th style="text-align:center;padding-right:5px;width:11%;" class="hidden">Available Stock</th>
                </tr>
                <?php foreach ($this->data as $item) { ?>
                    ...
                    <tr class="tablecni" id="hoverTr">
                        ...
                        <td style="text-align:left;padding-left: 5px;" class=""><a href='#' onclick='editrec(<?php echo $item->id ?>)'><?php echo $item->itemCode ?></a></td>
                        <td style="text-align:left;padding-left: 5px;" class=""><?php echo $item->description ?></td>
                        <td style="text-align:left;padding-left: 5px;" class=""><?php echo $item->abbreviation ?></td>
                        <td style="text-align:right;padding-right: 5px;" class=""><?php echo $item->productType ?></td>
                        <td class=""><?php echo Controller::getFloat($item->purchaseCost) ?></td>
                        <td class="stat"style="text-align:center;padding-right: 5px;"><?php echo Controller::getFloat($item->srp) ?></td>
                        <td style="text-align:left;padding-right: 5px;" class="hidden"><?php echo $item->availableStock ?></td>
                    </tr>
                <?php } ?>
