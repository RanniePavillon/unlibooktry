...
if (isset($_POST['invoiceid'])) {
    $invoice = DAOFactory::getTblItemDAO()->load($_POST['invoiceid']);
        ...
        <?php if ($invoice->status == 'posted') { ?>
            <div class="leftSideOR hiddens">
                <div>
                    <table class="tblORvatLeftSide hiddens">
                        ...
                        <tr>
                            <th class="lightGrayTD"><?= $invoice->itemCode ?></th>
            ...
            <div class="rightSideOR">
                ...
                <div style="float:right;">
                    ...
                    <div class="ORNumber"><?php echo $invoice->itemCode ?></div>
                </div>
                <div style="clear:both;"></div>
                ...
                if (count($taskline) > 0) {
                    ...
                    <div style="text-indent:20px;margin-top:20px;">
                        ...
                        foreach ($taskline as $i => $task) {
                            $task1 = DAOFactory::getTblTaskDAO()->load($task->itemDescription);
