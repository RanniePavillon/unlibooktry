...
function data() {
    $_POST['invoiceid'] = $_GET['salesorderid'];

    $client = new TblClient();
    $invoice = new TblSalesOrder();
    $taskline = array();
    
    $invoiceAmount = new TblSalesOrderAmount();
...
//        return $_POST['invoiceid'];
        ...
        $invoiceAmt = DAOFactory::getTblSalesOrderAmountDAO()->queryBySalesOrderId($invoice->id);
    ...
    $data = '<br>
			<div id="newInvoice" style="text-align:center;border:1px solid #000;">SALES ORDER</div>
			<br/>
    ...
    $data .= '<br/>' .
            ...
            '<td style="font-size:12px;height:18px;text-align:right;border-bottom:solid 1px black;background-color: #C8C8C8;cellpadding=4; border-top:solid 1px black;font-weight:bold; border-bottom:solid 1px black ">' . number_format((float) $subtotal + $vattotal - $discounttotal, 2) . '</td>' .
