...
<div class="container">
    <form method="post" class="cmForm boxshadow" id="form" >
        ...
        <div id="new1Client">
            <p class="ni1Client"><?php //echo ($task == 'addclient') ? 'CREATE NEW' : 'UPDATE'   ?>CREATE NEW WAREHOUSE</p>
        ...
        <div class="formCm">
            <table class="formCmtable">
                <tr>
                    <td>Warehouse No.:</td>
                    <td><input type="text" name="warehouseCode" value="<?php echo $this->warehouse->warehouseCode ?>" required></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td><label>Active: <input type="checkbox" name="activeAccount" class="activeLocation" checked <?php echo $this->warehouse->activeAccount == 'yes' ? "checked" : "" ?>></label></td>
                    <td></td>
                </tr>
            </table>
        </div>
