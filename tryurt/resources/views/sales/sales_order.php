...
<div class="mainbodyInvoice footerHeight">
    <form method='post' action='<?php echo URL ?>sales/salesOrder?page=<?= $page ?>&ipp=<?= $ipp ?>' id='form'>
        <div class="invoiceHolderInvoice ">
            <div id="newInvoice" class="headings">
                <label class="headText">ALL SALES ORDER</label>
                <?php if ($useraccess->Add == 'yes') { ?>
                    <a href="<?php echo URL ?>sales/newSalesOrder">	
                        <!-- <label class="crossSalesOrder"> -->
                            <input type="button" class="createNI buttonslarge" value="CREATE NEW SALES ORDER">
                    </a>
                        <?php } ?>
                        </div>	
                        ...
                        <div class="moduleHeight">
                            ...
                            <table class="cnitableAllInvoice">
                                <tr class="cnitableAllInvoiceTr" id="hoverTr">
                                    ...
                                    <th style="text-align:right;padding-right: 5px;width:12%;">SO Amount</th>
                                ...
                                if ($this->data) {
                                    foreach ($this->data as $item) {
                                        ...
                                        <tr class="tablecni" id="hoverTr">
                                            ...
                                            <td style="text-align:left;padding-left: 5px;" class=""><a onclick="editrec(<?php echo $item->id ?>)"><?php echo $item->salesOrderNo ?></a></td>
