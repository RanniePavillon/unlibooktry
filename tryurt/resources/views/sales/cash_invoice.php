<?php
Session::setSession('cashinvoiceid', '');
?>
<style>
    .cnitableAllInvoice{
...
<div class="mainbodyInvoice footerHeight">
    <form method='post' action='<?php echo URL ?>sales?page=<?= $page ?>&ipp=<?= $ipp ?>' id='form'>
        <div class="invoiceHolderInvoice">
            <div id="newInvoice" class="headings">
                <label class="headText">ALL CASH INVOICE</label>
                <?php if ($useraccess->Add == 'yes') { ?>
                    <a href="<?php echo URL ?>sales/newCashInvoice">	
                        <!-- <label class="crossCashInvoice"> -->
                            <input type="button" class="createNI buttonslarge" value="CREATE NEW CASH INVOICE">
                            </a>
                        <?php } ?>
                        </div>	
                            ...
                            <div style="float:right;margin-right:30px;margin-top:4px;">
                                ...
                                <label class="labelclass">
                                    <select class="inumber" name="searchby" id="searchby">
                                        <option class="invNoOption" value="1" <?php echo ($searchby == 1) ? 'selected' : '' ?>>CI NO.</option>
                        ...
                        <div class="moduleHeight">
                            ...
                            <table class="cnitableAllInvoice">
                                <tr class="cnitableAllInvoiceTr" id="hoverTr">
                                    ...
                                    <th style="text-align:left;padding:5px;padding-left: 5px;width:11%;"><a onclick="sort('invoice', '<?php echo ($sortdirection == 'desc') ? 'asc' : 'desc' ?>')">CI No.</a></th>
                                    ...
                                    <!-- <th style="text-align:left;padding-right:0px;width:15%;">Remarks</th> -->
                                    <th style="text-align:left;padding-right: 5px;width:12%;">Total Amount</th>
                                ...
                                if ($this->data) {
                                    foreach ($this->data as $item) {
                                        ...
                                        <tr class="tablecni" id="hoverTr">
                                            ...
                                            <td style="text-align:left;padding-left: 5px;" class=""><a onclick="editrec(<?php echo $item->id ?>)"><?php echo $item->cashSalesInvoiceNo ?></a></td>
                                            ...
                                            <!-- <td style="text-align:left;padding-right: 5px;" class=""><?php echo $item->remarks?></td> -->
                                            <td style="text-align: left" class=""><?php echo Controller::getFloat($item->grandTotal) ?></td>
                                            <td class="stat"style="text-align:center;padding-right: 5px;"><?php echo ucfirst($item->status) ?></td>
                                            <td style="text-align:left;padding-right: 5px;"><?php echo $item->dateReversed == '0000-00-00 00:00:00' ? '' : date('m/d/Y', strtotime($item->dateReversed)) ?></td>
                                        </tr>
                                        <?php
                                    }
                                }
