...
?>
<link href="<?= URL ?>views/sales/css/print_invoice.css" rel="stylesheet" type="text/css">
...
<div class="invoiceHolderInvoicePrint">
    <form class="PaymentTypeFormInvoice" style="padding-bottom:20px;">
		...
		<?php 
			//print_r($client);
		?>
       <div id="newInvoicePrint" style="margin-top:34px!important;">SALES RETURN</div>
                ...
                <table class="tblInvoice2">
                    <thead>
						...
						<th style="text-align:left;width:30%;background:#c8c8c8!important;border:1px solid #000!important;">Particular</th>
                            <th style="width:17%;background:#c8c8c8!important;border:1px solid #000!important;">Returned Quantity</th>
                    ...
                    <?php foreach ($taskline as $i => $task) { ?>
                        ...
                        <tr class="<?php echo ($i == count($taskline)) ? 'tblInvoicepaddingbottom' : '' ?>">
                            ...
                            <td style="text-align:center;"><?php echo $task->returnQty ?></td>
				...
				<tr class="">
                    ...
                    <td>
						<input type="text" readonly="readonly" value="<?php
                                ...
                                echo Controller::getFloat($invoiceamount->grandTotal);
                                ?>" class="inputTotalInvoice numeric" style="font-weight:bold;"/>
					</td>
                </tr>
		...
		<?php } else { ?>
			<div class="regcontainer useof" style="font-family:Verdana;font-size:12px;margin-left: 15px;">
...
<script>
	function viewpdf(invoiceid) {
        window.open(URL + 'sales/pdfview?salesreturnid='+invoiceid) 
