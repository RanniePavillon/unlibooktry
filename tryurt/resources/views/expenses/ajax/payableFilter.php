...
<script>
	$(function(){
		...
		function loadExpenseList(){
			...
			$.post(URL + 'expenses/loadListPayable',{'search':search, 'type':type, 'pageNumber': pageNumber, 'page' : page})
		...
		function setPagenation(){
			...
			type = $('.inumberAllExp').val();
			pageNumber = $('.paginateNumber').val();
			$.post(URL + 'expenses/payablePagenation',{'search':search, 'type':type, 'pageNumber': pageNumber})
				.done(function(returnData){
					$('.cnitableExpHolderPage').html(returnData);
				});
