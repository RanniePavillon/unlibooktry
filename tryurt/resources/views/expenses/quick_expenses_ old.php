...
<div class="mainbodyExpenses dsply">
	...
	<div class="quickExpenseHolder">
		<div id="newAllExp" class="headings" style="margin-bottom:5px;">
			<label class="allexp">QUICK EXPENSES</label>
		</div>
		<div style="float:right;margin-right:10px;">
			<a href="<?= URL ?>expenses/quickExpensesImEx"><input type="button" value="IMPORT/EXPORT" class="imEx"></a>
		</div>
		<div style="clear:both;margin-left:10px;font-family:agency fb2;font-size:18px;font-weight:bold;">
			Record cash paid expenses and without WHT here
		</div>
