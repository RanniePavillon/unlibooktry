...
function data() {
	...
	$trialbalance = TblTrialBalanceMysqlExtDAO::getTrialBalanceByType($id, 'expense', 'balance');
				...
				<div class="evHolder expense_holder">
					<div style="text-align:center;">
						<div class="companyInfo" style="font-size:22px;">
							'.
							(($expense->glPosting != 3 ) ? 'CHECK VOUCHER' : 'CASH VOUCHER')
							. '
						</div>
					</div>
					<br/>
					<table class="inpEV inpEV3">
						...
						<tr class="EDR">
							<td></td>
							<td>
								Ref No.: ' . $expense->referenceNumber . '
							</td>
						</tr>
					</table>
					<table class="inpEV inpEV3">
					...
					<table class="ulSignatory" cellspacing="5">
						...
						<tr>
							<td class="inpEV" style="width:150px;margin-top:10px;border-bottom:1px solid black;"></td>
							<td class="inpEV" style="width:150px;margin-top:10px;border-bottom:1px solid black;"></td>
							<td class="inpEV" style="width:150px;margin-top:10px;border-bottom:1px solid black;"></td>
							<td class="inpEV" style="width:150px;margin-top:10px;border-bottom:1px solid black;"></td>
						</tr>
