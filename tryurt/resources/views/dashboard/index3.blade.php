<style>
    ...
    .starthere {
        ...
        margin-top: 9px;
        margin-left: 83px;
        background-image: url('{{asset('images/start.png')}}');
        border: none;
    ...
    .tune {
        ...
        margin-top: 5px;
        margin-left: 5px;
        background-image: url('{{asset('images/tune.png')}}');
        border: none;
        background-repeat: no-repeat;
        margin-bottom: 5px;
    }
...
<div class="DashboardContainer">
    ...
    <div>
        ...
        <div class="setupyourAccount2">
            ...
            <div class="setupyourAccountIn"><img class="setAccountpic" src="{{asset('images/setupaccount2.png')}}">
            </div>
            <div><input type="button" class="starthere"></div>
        </div>
        <div class="setupyourAccount3">
            <div class="text1">Create an Expenses</div>
            <div class="setupyourAccountIn"><img class="setAccountpic" src="{{asset('images/setupaccount3.png')}}">
            </div>
