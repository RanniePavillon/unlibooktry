<style>
    ...
    <div class="invoiceHolderInvoicePrint">
        <form class="PaymentTypeFormInvoice" style="padding-bottom:20px;">
            ...
            <div id="newInvoicePrint" style="margin-top:34px!important;">RECEIVING REPORT</div>
            <div style="float:left;">
                <table class="tbleInvoice">
                    <tr class="invoicetr">
                        <td>Vendor Name:</td> 
                        <td><?php
                        $supplier = DAOFactory::getTblSupplierDAO()->load($this->receiveorder->supplierId);
                        echo $supplier->name
                        ?></td>
            ...
            <div style="float:right;margin-right:30px;">	
                <table class="tbleInvoice2">	
                    <tr class="invoicetr">
                        <td>Receiving No.:</td>
                        <td style="text-align:right;"><?php echo $this->receiveorder->receivedOrderNo ?></td>
                    </tr>
                    <tr class="invoicetr">
                        <td>PO No.:</td>
                        <td style="text-align:right;"><?php echo DAOFactory::getTblPurchaseOrderDAO()->load($this->receiveorder->purchaseOrderId)->purchaseOrderNo ?></td>
                    </tr>					
                    <tr class="invoicetr">
                        <td>Receiving Date:</td> 
                        <td style="text-align:right;"><?php echo date('m/d/Y', strtotime($this->receiveorder->dateIssued)) ?></td>
                    </tr>	
                    <tr class="invoicetr">	
                        <td>Ref. No.:</td>
                        <td style="text-align:right;"><?php echo $this->receiveorder->refNo ?></td>
                    </tr>
                    <tr class="invoicetr">
                        <td >Discount <?php echo $this->receiveorder->discount > 0 ? 'In percent' : 'In amount' ?>:</td>
                        <td>
                            <span style="padding-left:20px;">
                                <?php echo $this->receiveorder->discount > 0 ? $this->receiveorder->discount . '%' : Controller::getFloat($this->receiveorderamount->discountPesoAmount) ?>
                            </span>
                        </td>
                    </tr>
                </table>
            ...
            <div style="margin-top:24px;">	
                <table class="tblInvoice2">
                    ...
                    <?php foreach ($this->receiveorderlines as $i => $item) { ?>
                        <tr class="<?php echo ($i == count($this->receiveorderlines)) ? 'tblInvoicepaddingbottom' : '' ?>">
            ...
            <table class="tbl3Invoice2">
                <tr class="">
                    ...
                    <td>
                        <input type="text" readonly="readonly" value="<?php echo Controller::getFloat($this->receiveorderamount->subTotalAmount) ?>"
                ...
                <tr class="trTotalInvoices">
                    ...
                    <td class="">
                        <input type="text" readonly="readonly" value="<?php echo Controller::getFloat($this->receiveorderamount->vatAmount) ?>" class="inputTotalInvoice2 numeric">
                    </td>
                </tr>
                ...
                <tr class="trTotalInvoices" style="border-bottom: 1px solid #000;">
                    ...
                    <td class="">
                        <input type="text" readonly="readonly" value="<?php echo Controller::getFloat($this->receiveorderamount->discountAmount) ?>" class="inputTotalInvoice2 numeric">
                    </td>
                </tr>
                ...
                <tr class="trTotalInvoicesGr">
                    ...
                    <td class="" id="">
                        <input type="text" readonly="readonly" value="<?php echo Controller::getFloat($this->receiveorderamount->grandTotal) ?>" class="inputTotalInvoice3 numeric">
                    </td>
                </tr>
            </table>
