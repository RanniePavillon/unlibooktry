...
<div class="invoiceHolderInvoicePrint">
    <form class="PaymentTypeFormInvoice" style="padding-bottom:20px;">
        ...
        <input type="button" class="pdf hidden" value="PDF" onclick="viewpdf(<?php echo $this->purchaseinvoice->id ?>)" style="">
        ...
        <div id="newInvoicePrint" style="margin-top:34px!important;">PURCHASE INVOICE</div>
        <div style="float:left;">
            <table class="tbleInvoice">
                <tr class="invoicetr">
                    <td>Vendor Name:</td> 
                    <td><?php
                        $supplier = DAOFactory::getTblSupplierDAO()->load($this->purchaseinvoice->supplierId);
                        echo $supplier->name;
                        ?></td>
        ...
        <div style="float:right;margin-right:30px;">	
            <table class="tbleInvoice2">	
                <tr class="invoicetr">
                    ...
                    <td style="text-align:right;"><?php echo $this->purchaseinvoice->purchaseInvoiceNo ?></td>
                </tr>
                <tr class="invoicetr">
                    <td>Recieve Order No.:</td>
                    <td style="text-align:right;"><?php echo DAOFactory::getTblReceivedOrderDAO()->load($this->purchaseinvoice->receivedOrderId)->receivedOrderNo ?></td>
                </tr>					
                <tr class="invoicetr">
                    <td>Purchase Date:</td> 
                    <td style="text-align:right;"><?php echo date('m/d/Y', strtotime($this->purchaseinvoice->dateIssued)) ?></td>
                </tr>	
                <tr class="invoicetr">	
                    <td>Ref. No.:</td>
                    <td style="text-align:right;"><?php echo $this->purchaseinvoice->refNo ?></td>
                </tr>
                <tr class="invoicetr">
                    <td >Discount <?php echo $this->purchaseinvoice->discount > 0 ? 'In percent' : 'In amount' ?>:</td>
                    <td>
                        <span style="padding-left:20px;">
                            <?php echo $this->purchaseinvoice->discount > 0 ? $this->receiveorder->discount . '%' : Controller::getFloat($this->purchaseInvoiceAmount->discountPesoAmount) ?>
                        </span>
                    </td>
                </tr>
            </table>
            ...
            <table class="tblInvoice2">
                <thead>
                    <tr class="newTblInv">
                        ...
                        <th style="width:25%;text-align:left;background:#c8c8c8!important;border:1px solid #000!important;">Item Description</th>
                        <th style="text-align:center;width:7%;background:#c8c8c8!important;border:1px solid #000!important;">UOM</th>
                        <th style="text-align:center;width:7%;background:#c8c8c8!important;border:1px solid #000!important;">Received Qty</th>
                        <th style="text-align:center;width:7%;background:#c8c8c8!important;border:1px solid #000!important;">Purchased Qty</th>
                        <th style="width:14%;background:#c8c8c8!important;border:1px solid #000!important;text-align:right;">Amount</th>
                        <th style="width:10%;background:#c8c8c8!important;border:1px solid #000!important;text-align:right;">Discount</th>
                        <th style="width:16%;text-align:right;background:#c8c8c8!important;border:1px solid #000!important;">Net Amount</th>
                    </tr>
                </thead>
                <?php
                foreach ($this->purchaseinvoicelines as $item) {
                    ?>
                    <tr class="<?php echo ($i == count($this->purchaseinvoicelines)) ? 'tblInvoicepaddingbottom' : '' ?>">
                        ...
                        <td style="text-align:center;"><?php echo $item->receivedQty ?></td>
                        <td style="text-align:center;"><?php echo $item->purchasedQty ?></td>
        ...
        <table class="tbl3Invoice2">
            <tr class="">
                ...
                <td>
                    <input type="text" readonly="readonly" value="<?php echo Controller::getFloat($this->purchaseInvoiceAmount->subTotalAmount) ?>"
            ...
            <tr class="trTotalInvoices">
                ...
                <td class="">
                    <input type="text" readonly="readonly" value="<?php echo Controller::getFloat($this->purchaseInvoiceAmount->vatAmount) ?>" class="inputTotalInvoice2 numeric">
                </td>
            </tr>
            ...
            <tr class="trTotalInvoices" style="border-bottom: 1px solid #000;">
                ...
                <td class="">
                    <input type="text" readonly="readonly" value="<?php echo Controller::getFloat($this->purchaseInvoiceAmount->discountAmount) ?>" class="inputTotalInvoice2 numeric">
                </td>
            </tr>
            ...
            <tr class="trTotalInvoicesGr">
                ...
                <td class="" id="">
                    <input type="text" readonly="readonly" value="<?php echo Controller::getFloat($this->purchaseInvoiceAmount->grandTotal) ?>" class="inputTotalInvoice3 numeric">
                </td>
            </tr>
        </table>
