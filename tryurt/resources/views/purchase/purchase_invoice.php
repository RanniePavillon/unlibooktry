...
?>
<title>
    ALL PURCHASED INVOICE
</title>
<link rel="stylesheet" href="<?php echo URL; ?>public/css/overall.css"/>
<div class="mainbodyInvoice footerHeight">
    <form method='post' action='<?php echo URL ?>purchase/purchaseInvoice?page=<?= $page ?>&ipp=<?= $ipp ?>' id='form'>
        <div class="invoiceHolderInvoice">
            <div id="newInvoice" class="headings">
                <label class="headText">ALL PURCHASED INVOICE</label>
                <?php if ($useraccess->Add == 'yes') { ?>
                    <a href="<?php echo URL ?>purchase/newPurchaseinvoice">	
                        <!-- <label class="crossPurchaseInvoice"> -->
                ...
                <div style="float:right;margin-right:30px;margin-top:4px;">
                    ...
                    <label class="labelclass">
                        <select class="inumber" name="searchby" id="searchby">
                            <option class="invNoOption" value="1" <?php echo ($searchby == 1) ? 'selected' : '' ?>>PI NO.</option>
        ...
        <div class="moduleHeight">
            ...
            <table class="cnitableAllInvoice">
                <tr class="cnitableAllInvoiceTr" id="hoverTr">
                    ...
                    <th style="text-align:left;padding:5px;padding-left: 5px;width:11%;"><a onclick="sort('invoice', '<?php echo ($sortdirection == 'desc') ? 'asc' : 'desc' ?>')">PI No.</a></th>
                ...
                if ($this->data) {
                    foreach ($this->data as $item) {
                        ...
                        <tr class="tablecni" id="hoverTr">
                            ...
                            <td style="text-align:left;padding-left: 5px;" class=""><a href="#" onclick="editrec(<?php echo $item->id ?>)"><?php echo $item->purchaseInvoiceNo ?></a></td>
