...
<script>
    ...
    $(function () {
        ...
        $('#btnsubmit').click(function () {
            ...
            if (siId != '') {
                ...
                $('option:last', $('.purchaseinvoice')).before($('<option/>', {
                    value: siId,
                    text: code,
                    selected: true,
                    'class': 'list'
            ...
            $.post(URL + 'purchasereturn/getPurchaseInvoiceTask', {purchaseinvoiceid: siId, itemIds: chks})
    ...
    function getData() {
        $.post(URL + 'purchasereturn/getPIFilter', $('#formpi').serialize())
                .done(function (returnData) {
                    $('#tbl_pi > tbody').html(returnData);
                });
    }
</script>
<div class="invoiceHolderCNTs">
    <form method="post" action="" class="cnt-formCNTs boxshadow" id="formpi">
        <div id="newCNTs">
            PURCHASE INVOICE
        </div>
        <div class="center2">
		...
		<div class="dropdownTableContainer">
			<table class="dropdownTables" id="tbl_pi" style="width:100%;">
				<thead>
				<tr>
					<th style="padding-left: 10px;">PI No.</th>
					<th>Date</th>
        ...
        <div class="divCNTsBelowitem">	
            ...
            <input type="button" class="addsavebuttonpop isButton saveAddButtonsPop" id="btnsubmit" value="Get PI Line">
        </div>
