...
<div class="mainbodyInvoice footerHeight">
    <form method='post' action='<?php echo URL ?>purchase?page=<?= $page ?>&ipp=<?= $ipp ?>' id='form'>
        <div class="invoiceHolderInvoice">
            <div id="newInvoice" class="headings">
                <label class="headText">ALL PURCHASE ORDER</label>
                <?php if ($useraccess->Add == 'yes') { ?>
                    <a href="<?php echo URL ?>purchase/newPurchaseOrder">	
                        <!-- <label class="crossPurchaseOrder">  -->
                            <input type="button" class="createNI buttonslarge" value="CREATE NEW ORDER">
                        <!-- </label> -->
                    </a>
                <?php } ?>
            </div>	
        ...
        <div class="moduleHeight">
            ...
            <table class="cnitableAllInvoice">
                <tr class="cnitableAllInvoiceTr" id="hoverTr">
                    ...
                    <th style="text-align:left;padding:5px;padding-left: 5px;width:11%;"><a onclick="sort('invoice', '<?php echo ($sortdirection == 'desc') ? 'asc' : 'desc' ?>')">PO No.</a></th>
                    ...
                    <th style="text-align:right;padding-right: 5px;width:12%;">Purchased Amount</th>
                ...
                if ($this->data) {
                    foreach ($this->data as $item) {
                        ...
                        <tr class="tablecni" id="hoverTr">
                            ...
                            <td style="text-align:left;padding-left: 5px;" class=""><a href="#" onclick="editrec(<?php echo $item->id ?>)"><?php echo $item->purchaseOrderNo ?></a></td>
...
<script>
    ...
    $(function () {
    invoiceprintview = '<?= Session::getSession('purchaseorderid') ?>';
