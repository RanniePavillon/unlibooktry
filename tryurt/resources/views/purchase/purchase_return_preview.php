<style>
    ...
    <div class="invoiceHolderInvoicePrint">
        <form class="PaymentTypeFormInvoice" style="padding-bottom:20px;">
            ...
            <input type="button" class="pdf hidden" value="PDF" onclick="viewpdf(<?php echo $invoice->id ?>)" style="">
            ...
            <div id="newInvoicePrint" style="margin-top:34px!important;">PURCHASE RETURN</div>
            <div style="float:left;">
                <table class="tbleInvoice">
                    <tr class="invoicetr">
                        <td>Vendor Name:</td> 
                        <td><?php
                            $supplier = DAOFactory::getTblSupplierDAO()->load($this->purchasereturn->supplierId);
                            echo $supplier->name
                            ?></td>
            ...
            <div style="float:right;margin-right:30px;">	
                <table class="tbleInvoice2">	
                    <tr class="invoicetr">
                        <td>PR No.:</td>
                        <td style="text-align:right;"><?php echo $this->purchasereturn->purchaseReturnNo ?></td>
                    </tr>
                    <tr class="invoicetr">
                        <td>Purchase Invoice No.:</td>
                        <td style="text-align:right;"><?php echo DAOFactory::getTblPurchaseInvoiceDAO()->load($this->purchasereturn->purchaseInvoiceId)->purchaseInvoiceNo ?></td>
                    </tr>					
                    <tr class="invoicetr">
                        <td>PR Date:</td> 
                        <td style="text-align:right;"><?php echo date('m/d/Y', strtotime($this->purchasereturn->dateIssued)) ?></td>
                    </tr>	
                    <tr class="invoicetr">	
                        <td>Ref. No.:</td>
                        <td style="text-align:right;"><?php echo $this->purchasereturn->refNo ?></td>
                    </tr>
                    <tr class="invoicetr">
                        <td >Discount <?php echo $this->purchasereturn->discount > 0 ? 'In percent' : 'In amount' ?>:</td>
                        <td>
                            <span style="padding-left:20px;">
                                <?php echo $this->purchasereturn->discount > 0 ? $this->purchasereturn->discount . '%' : Controller::getFloat($this->purchasereturnamount->discountPesoAmount) ?>
                            </span>
                        </td>
                    </tr>
                </table>
                ...
                <table class="tblInvoice2">
                    <thead>
                        <tr class="newTblInv">
                            ...
                            <th style="text-align:center;width:7%;background:#c8c8c8!important;border:1px solid #000!important;">Returned Qty</th>
                    ...
                    <?php
                    foreach ($this->purchasereturnlines as $item)
                        
                        ?>
                    <tr class="<?php echo ($i == count($this->purchasereturnline)) ? 'tblInvoicepaddingbottom' : '' ?>">
                        ...
                        <td style="text-align:center;"><?php echo $item->invoiceQty ?></td>
                        <td style="text-align:center;"><?php echo $item->returnQty ?></td>
            ...
            <table class="tbl3Invoice2">
                <tr class="">
                    ...
                    <td>
                        <input type="text" readonly="readonly" value="<?php echo Controller::getFloat($this->purchasereturnamount->subTotalAmount) ?>"
                ...
                <tr class="trTotalInvoices">
                    ...
                    <td class="">
                        <input type="text" readonly="readonly" value="<?php echo Controller::getFloat($this->purchasereturnamount->vatAmount) ?>" class="inputTotalInvoice2 numeric">
                    </td>
                </tr>
                ...
                <tr class="trTotalInvoices" style="border-bottom: 1px solid #000;">
                    ...
                    <td class="">
                        <input type="text" readonly="readonly" value="<?php echo Controller::getFloat($this->purchasereturnamount->discountAmount) ?>" class="inputTotalInvoice2 numeric">
                    </td>
                </tr>
                ...
                <tr class="trTotalInvoicesGr">
                    ...
                    <td class="" id="">
                        <input type="text" readonly="readonly" value="<?php echo Controller::getFloat($this->purchasereturnamount->grandTotal) ?>" class="inputTotalInvoice3 numeric">
                    </td>
                </tr>
            </table>
