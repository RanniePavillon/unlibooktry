        ...
        $.extend({
            ...
            APP : {                
                ...
                startTimer : function(dir) {
                    ...
                    // reset state
                    $.APP.state = 'alive';   
                    $('#' + $.APP.dir + '_status').html('Issue is currently ongoing.');
                ...
                pauseTimer : function() {
                    ...
                    // set state
                    $.APP.state = 'pause';
                    $('#' + $.APP.dir + '_status').html('Support Agent is currently unavailable. They may be on Break/ Lunch. If you have any concerns regarding your issue please send an email to the address provided by your Support Agent.');
                ...
                stopTimer : function() {
                    ...
                    // set state
                    $.APP.state = 'stop';
                    $('#' + $.APP.dir + '_status').html('You have terminated the support for this issue.');
