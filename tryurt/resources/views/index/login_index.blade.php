<style>
    ...
    .tweetLanding{
        ...
        height: 20px;
        border: none;
        background-image: url('images/inpic.png');
        background-repeat: no-repeat;
        background-position: left;
        cursor: pointer;
            ...
            if(!allow_submit){
	            ...
	            if ($.trim(msg) == '') {
	                ...
	                if (msg == '1') {
		                ...
		                url: URL + "login/userLogin",
		                type: 'POST',
		                data: {'email': email, 'password': password, 'task': 'get subdomain'},
		                async: false,
		                error: function() {
		                    return 'Connection Error!';
		                }
		            ...
		            if(subdomain != '-s'){
		            	    sub_validate = $.ajax({
								url: URL + "login/userLogin",
								type: 'POST',
								data: {'email': email, 'password': password, 'subdomain': subdomain,'task': 'validate subdomain user'},
								async: false,
								error: function() {
									return 'Connection Error!';
								}
...
<body class="bgLanding">
    <div class="mainlanding">
        <form method="post" action="{{('login/userLogin')}}" name="landing" id="loginForm" >
            ...
            <div class="newlanding"> 
                ...
                <div>
                    <img src="{{('images/urt_landing_new.png')}}" class="ubServiceLogo">
                    <!--<img src="{{('images/service_landing_new3.png')}}" class="ubServiceLogo">-->
                </div>
                        ...
                        <div class="trial">
                            <div style="margin-left:20px;margin-right:20px;">
                                <!--<div style="text-align:center;">
                                        <img src="{{('images/button30daysred.png')}}" class="button30DaysFree">
                                </div>-->
                                <!--div class="trialTitle">
                                    <div class="30daytry">FREE <//?=NUMBERDAYS?>-DAY TRIAL</div>
                                </div-->
                                ...
                                <div style="text-align:center;" class="sblik">
								...
								<br/>
                                <div class="Or">
									<a href="{{('forgotpassword')}}" class="textlogin">Forgot your Password?</a>
								</div>
                            </div>
                        </div>
                    </div>
