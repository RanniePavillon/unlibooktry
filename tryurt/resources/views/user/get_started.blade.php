...
<body class="getstartedbody">
    ...
    <div class="invoiceHolderLog1">
        <form method="post" action="{{('user/userRegister')}}" class="companyFormLog1">
            <div id="newLog1">
                <div class ="divlog1">
                    <div class="titlelog1"><img class="logoStart"  src="{{asset('images/logotrans.png')}}"></div>
                    <div class="title2log1">Start your 30-days free trial</div>

                    <table>
                        <tr class="getStartedTr">
                            <td class="titlelog1getstarted">Full Name:</td>
                            <td class="inputstarted">
								<input type="text" class="InputGetStarted" name="name" required maxlength="100">
							</td>
                        </tr>
                        <tr class="getStartedTr">
                    ...
                    <div class="divGetStarted" colspan="2" >Or<a href="{{('login')}}" class="textColor"> Log In<a> and if you already have an account.</div>
