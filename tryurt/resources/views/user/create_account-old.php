            ...
            <!--<img src="/unlibooks/public/images/puppet.png">-->
				...
				<table class="userAccountTable">
					...
					<tr>
						...
						<td><input type="text" required name="name" class="bgInput" maxlength="100"></td>
					</tr>
				</table>
			...
			<div style="float:left;">
				...
				<table class="userAccountTable">
					...
					<tr>
						...
						<td rowspan="1"><textarea name="address" class="bgInput2"></textarea></td>
					</tr>
					<tr>
						<td>PHONE NUMBER:</td>
						<td><input type="text" name="phoneNum" class="bgInput" style="margin-left:33px!important;" maxlength="30"></td>
					</tr>
					<tr>
						<td>FAX NUMBER:</td>
					...
					<tr>
						...
						<td>
							...
							value="<?php echo (Session::getSession('email')!='') ? Session::getSession('email') : '' ?>">
						</td>
					</tr>
					<tr>
						<td>BUSINESS TYPE:</td>
