n<style>
    ...
    @media print{
        #headerHead, #accpLiveChat, .mainbodyExpenses, .footerHolderNew, .invoiceHolderExpense, .voucher, .mainbodyAccounting{
            display:none;
        }
        .evHolder{
...
<?php
$journalEntry = $this->getJournalEntry;
$journalEntryLines = $this->getJournalEntryLines;
...
<div class="evCont">
    <div class="evHolder expense_holder">
        ...
        <div class="compInfo" style="float:left;text-align:center;margin-left:207px;margin-top:5px;">
            <input type="text" id="journalEntry_id" class="hidden" value="<?= $_POST['id'] ?>">
        ...
        <div class="rightInfo" style="float:right;margin-right:30px;">
            <ul class="rightInfor">
                <li>Journal No.: <input type="text" class="inpEV" value="<?= $journalEntry->journalNumber ?>" readonly style="margin-left:3px;"></li>
                <li>Date Issued: <input type="text" class="inpEV" style="letter-spacing:1;margin-left:6px;" value="<?= date('m/d/Y', strtotime($journalEntry->dateCreated)) ?>" readonly></li>
