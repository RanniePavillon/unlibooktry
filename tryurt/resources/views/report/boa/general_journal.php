...
<?php
    $report = $this->checkGeneralJournal;
?>
	<title>
		REPORTS
	</title>
...
<div class="reportHolderContainer trhidden">
	...
	?>
		<div class="noJournal noclass">
			You don't have General Journal.
		</div>
	<?php
	}
	?>
...
<script>
	$(function(){
		...
		$('form').submit(function() {
			...
			$.post(URL + 'report/genGeneralJournal', 
				{
		...
		$('.exportButton').click(function(){
			location = URL + 'report/exportGeneralJournal?startdate='+$('input[name="startdate"]').val()+'&enddate='+$('input[name="enddate"]').val();
		});
	...
	$('.viewMode').click(function() {
		...
		window.open(URL + 'report/newtab_generalJournal?startdate=' + startdate + '&enddate=' + enddate);
