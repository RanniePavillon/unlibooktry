...
<?php
	$report = $this->checkInventoryBook;
?>
...
<form method='post' action='<?php echo URL ?>report/new_salesitem' id='form'>
	<div class="mainformitemsum">
		<div class="sbis reportTitle">Inventory Book</div>
		<div class="buttonFS">
...
<script>
	...
	$('form').submit(function() {
		...
		// $('.reportHolderContainer').html(loading);
			$.post(URL + 'report/genInventoryBook', 
				{
	...
	$('.exportSalesTask').click(function(){
		...
		location = URL + 'report/exportInventoryBook?startdate=' + startdate + '&enddate=' + enddate;
	});
	...
	/* viewMode codes */
		...
		/* $('.viewMode').click(function() {
			...
			window.open(URL + 'report/newtab_Inventory?startdate=' + startdate + '&enddate=' + enddate);
