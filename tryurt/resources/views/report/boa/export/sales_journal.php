<?php
	...
	header('Content-Disposition: attachment; filename="sales_journal.xls"');
?>
<?php
	$org = $this->org;
	$info = $this->info;
		...
		<div class="fromReg formJournalNew">
			...
			?>
				...
				<tr>
					...
					<td style="text-align: left;" class="reportTd"><?= $each['tin_num']?></td>
					<td style="text-align: left;" class="reportTd"><?= $each['client_account']?></td>
					...
					<td style="text-align: left;" class="reportTd"><?= $each['cash_sales_invoice_no']?></td>
					<td style="text-align: right;" class="reportTd"><?= Controller::getFloat($each['Amount'])?></td>
					<td style="text-align: right;" class="reportTd"><?= Controller::getFloat($each['NetSales'])?></td>
				</tr>
				<?php
					}
				?>
