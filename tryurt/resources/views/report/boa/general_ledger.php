...
<?php
    $report = $this->checkGeneralLedger;
?>
	<title>
		REPORTS
	</title>
...
<script>
	$(function(){
		...
		$('form').submit(function() {
			...
			$.post(URL + 'report/genGeneralLedger', 
				{
		...
		$('.exportButton').click(function(){
			location = URL + 'report/exportGeneralLedger?startdate='+$('input[name="startdate"]').val()+'&enddate='+$('input[name="enddate"]').val();
		});
	...
	$('.viewMode').click(function() {
		...
		window.open(URL + 'report/newtab_generalLedger?startdate=' + startdate + '&enddate=' + enddate);
