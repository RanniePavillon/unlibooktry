...
<?php
    $report = $this->checkPurchaseJournal;
?>
	<title>
		REPORTS
	</title>
...
<div class="reportHolderContainer trhidden">
	...
	?>
		<div class="noJournal noclass">
			You don't have Purchase Journal.
		</div>
	<?php
	}
	?>
...
<script>
	$(function(){
		...
		$('form').submit(function() {
			...
			$.post(URL + 'report/genPurchaseJournal', 
				{
		...
		$('.exportButton').click(function(){
			location = URL + 'report/exportPurchaseJournal?startdate='+$('input[name="startdate"]').val()+'&enddate='+$('input[name="enddate"]').val();
		});
	...
	$('.viewMode').click(function() {
		...
		window.open(URL + 'report/newtab_purchaseJournal?startdate=' + startdate + '&enddate=' + enddate);
