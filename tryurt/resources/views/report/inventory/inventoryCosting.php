...
@media print { 
	...
	.reportHolderOR{
		...
		border:none !important;
		width:100% !important;
		height:auto !importantto		zoom:140%;
	}
	.tblmainsumlist th{
		color:#000 !important;
	}
...
//        print_r($info->emailAddress); exit;
	...
	$report = $this->getInventoryCosting;
?>
...
<form method='post' action='<?php echo URL ?>report/new_salesitem' id='form'>
	<div class="mainformitemsum">
		<div class="sbis reportTitle">Inventory Costing</div>
		<div class="buttonFS">
...
<script>
	...
	$('form').submit(function() {
		...
		// $('.reportHolderContainer').html(loading);
			$.post(URL + 'report/genInventoryCosting', 
				{
	...
	$('.exportSalesTask').click(function(){
		...
		location = URL + 'report/exportInventoryCosting?startdate=' + startdate + '&enddate=' + enddate + '&item=' + item;
	});
