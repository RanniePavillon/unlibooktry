$(function(){
	...
	$('input[name="item1_month"],' + 
		' input[name="item1_year"],' +
		' input[name="item6[]"],' +
		' input[name="item12"],' +
		' input[name="item7"],' +
		' input[name="item9"],' +
		...
		' input[name="item11"],' +
		' input[name="item13"],' +
		' input[name="part2Item15A"],' +
		' input[name="part2Item15B"],' +
		' input[name="part2Item16B"],' +
		' input[name="part2Item19A"],' +
		' input[name="part2Item19B"],' +
		' input[name="part2Item20F"],' +
		' input[name="part2Item21B"],' +
		' input[name="part2Item21D"],' +
		' input[name="part2Item21F"],' +
		' input[name="part2Item21H"],' +
		' input[name="part2Item21I"],' +
		' input[name="part2Item21J"],' +
		' input[name="part2Item21L"],' +
		' input[name="part2Item21O"],' +
		' input[name="part2Item21P"],' +
		' input[name="part2Item22"],' +
		' input[name="part2Item23F"],' +
		' input[name="part2Item24"],' +
		' input[name="part2Item25"],' +
		' input[name="part2Item26H"],' +
		' input[name="part2Item27"],' +
		' input[name="part2Item28D"],' +
		' input[name="part2Item29"]'
	).prop('readonly',true);
});