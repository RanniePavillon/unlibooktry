...
/*  @media print {
	.mainbodyInvoice, #container, .mainBody, #footer, #header, .footerHolderNew, input[type=button] {
		display: none;
	}
	.form1601cHolder{
		margin-left: 200px;
	...
	@media screen{
		...
		<div id="background">
			...
			<div id="Background">
				<img src="<?= $this->imageUrl ?>images/Background.png" class="img1601c">
			</div>
			<div id="item1m">
			...
			<div id="p1p15"><input type="text" class="inp1601c" name="part2Item15" value="<?= number_format((float) setData($form1601C,'part2Item15'), 2) ?>" readonly/></div>
			...
			<div id="p1p16c"><input type="text" class="inp1601c" name="part2Item16C" value="<?= number_format((float) setData($form1601C,'part2Item16C'), 2) ?>" readonly/></div>
			<div id="p1p17"><input type="text" class="inp1601c" name="part2Item17" value="<?= number_format((float) setData($form1601C,'part2Item17'), 2) ?>" readonly/></div>
			<div id="p1p18"><input type="text" class="inp1601c2" name="part2Item18" value="<?= number_format((float) setData($form1601C,'part2Item18'), 2) ?>" readonly/></div>
			...
			<div id="p1p20"><input type="text" class="inp1601c2" name="part2Item20" value="<?= number_format((float) setData($form1601C,'part2Item20'), 2) ?>" readonly/></div>
			...
			<div id="p1p22"><input type="text" class="inp1601c3" name="part2Item22" value="<?= number_format((float) setData($form1601C,'part2Item22'), 2) ?>" readonly/></div>
			<div id="p1p23"><input type="text" class="inp1601c3" name="part2Item23" value="<?= number_format((float) setData($form1601C,'part2Item23'), 2) ?>" readonly/></div>
			...
			<div id="p1p24d"><input type="text" class="inp1601c2" name="part2Item24D" value="<?= number_format((float) setData($form1601C,'part2Item24D'), 2) ?>" readonly/></div>
			<div id="p1p25"><input type="text" class="inp1601c2" name="part2Item25" value="<?= number_format((float) setData($form1601C,'part2Item25'), 2) ?>" readonly/></div>
		</div>
