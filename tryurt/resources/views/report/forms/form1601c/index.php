...
<div>
			...
			<div class="BSForm">
				...
				<div class="DFs">
					<div style="float:left;margin-left:15px;">
						...
						<label class="txtMOnthYear">Year:</label> <input type="number" name="year" value="<?= date('Y') ?>"  class="yearname selectYear"/>
	...
	<form class="hidden form1601cHolderForm">
		...
		<div class="buttonHolder itrbutton" style="float:right;">
			...
			<input type="button" value="POST" class="postform1601c addsavebutton buttonstyles2 addsavebuttonreports"/>
		</div>
		<div style="clear:both;"></div>
		
	<div class="gen101Holder">
		<div class="gen101">
			<div class="form1601cHolder divClass" id="divelement">
...
<script>
	$(function(){
		...
		$('.generate').click(function(){
			...
			$('.form1601cHolderForm').addClass('hidden');
			$.post( URL + 'report/form1601c/getReport',{'month':month, 'year':year})
				.done(function(returnData){
					$('.form1601cHolder').html(returnData);
		...
		$('.printPdf2').click(function(){
			...
			window.open(URL + 'report/form1601c/printReport?month=' + month + '&year=' + year);
			return false;
		});
