...
<script>
	...
	$('._22C').click(function(){
			...
			tempVal = $(this).parent().find('#item22C').val();
			
			$('#item22CValue').val(tempVal);
			$('._22B').val('');
			$('._22MI').val('');
	});
	$('._22B').click(function(){
			...
			tempVal = $(this).parent().find('#item22B').val();
			
			$('#item22BValue').val(tempVal);
			$('._22C').val('');
			$('._22MI').val('');
	});
	$('._22MI').click(function(){
			$('._22MI').val('');
			$(this).val('x');
			
			tempVal = $(this).parent().find('#item22MI').val();
			
			$('#item22MIValue').val(tempVal);
			$('._22C').val('');
			$('._22B').val('');
	});
	$('.item_23i').click(function(){
			$('.item_23i').val('');
			$(this).val('x');
			
			tempVal = $(this).parent().find('#item23Itemized').val();
			
			$('#item23itemizedValue').val(tempVal);
			$('.item_23o').val('');
	});
	$('.item_23o').click(function(){
			$('.item_23o').val('');
			$(this).val('x');
			
			tempVal = $(this).parent().find('#item23Osd').val();
			
			$('#item23osdValue').val(tempVal);
			$('.item_23i').val('');
	});
	$('.item_24i').click(function(){
			$('.item_24i').val('');
			$(this).val('x');
			
			tempVal = $(this).parent().find('#item24Itemized').val();
			
			$('#item24itemizedValue').val(tempVal);
			$('.item_24o').val('');
	});
	$('.item_24o').click(function(){
			$('.item_24o').val('');
			$(this).val('x');
			
			tempVal = $(this).parent().find('#item24Osd').val();
			
			$('#item24osdValue').val(tempVal);
			$('.item_24i').val('');
	});
	$('.item_25').click(function(){
			$('.item_25').val('');
			$(this).val('x');
			
			tempVal = $(this).parent().find('#item25').val();
			
			$('#item25Value').val(tempVal);
	});
</script>
		<link href="<?= $this->imageUrl ?>form1701q-001/styles.css" rel="stylesheet" type="text/css">
		<script src="<?= $this->imageUrl ?>form1701q-001/custom.js"></script>
		<div id="background">
			...
			<div id="item21st">
				...
				<input type="text" class="item_2" value="<?= $form1701q->item2 == '1st' ? 'x' : '' ?>">
				<input type="hidden" id="item2" value="1st">
			</div>
			<div id="item22nd">
				<input type="text" class="item_2" value="<?= $form1701q->item2 == '2nd' ? 'x' : '' ?>">
				<input type="hidden" id="item2" value="2nd">
			</div>
			<div id="item23rd">
				<input type="text" class="item_2" value="<?= $form1701q->item2 == '3rd' ? 'x' : '' ?>">
				<input type="hidden" id="item2" value="3rd">
			</div>
			<div id="item3yes">
				<input type="hidden" name="item3" id="item3Value">
				<input type="text" class="item_3" value="<?= $form1701q->item3 == 'yes' ? 'x' : '' ?>">
				<input type="hidden" id="item3" value="yes">
			</div>
			<div id="item3no">
				<input type="text" class="item_3" value="<?= $form1701q->item3 == 'no' ? 'x' : '' ?>">
			...
			<div id="item22compensation">
				<input type="hidden" name="item22Compensation" id="item22CValue">
				<input type="text" class="item_22_2 _22C" value="<?= $form1701q->item22Compensation == 'compensation' ? 'x' : '' ?>">
				<input type="hidden" id="item22C" value="compensation">
			</div>
			<div id="item22business">
				<input type="hidden" name="item22Business" id="item22BValue">
				<input type="text" class="item_22_2 _22B" value="<?= $form1701q->item22Business == 'business' ? 'x' : '' ?>">
				<input type="hidden" id="item22B" value="business">
			</div>
			<div id="item22mixedIncome">
				<input type="hidden" name="item22MixedIncome" id="item22MIValue">
				<input type="text" class="item_22_2 _22MI" value="<?= $form1701q->item22MixedIncome == 'mixedIncome' ? 'x' : '' ?>">
				<input type="hidden" id="item22MI" value="mixedIncome">
			</div>
			<div id="item23itemizedDeduct">
				<input type="hidden" name="item23Itemized" id="item23itemizedValue">
				<input type="text" class="item_23i item_23" value="<?= $form1701q->item23Itemized == 'mixedIncome' ? 'x' : '' ?>">
				<input type="hidden" id="item23Itemized" value="itemized">
			</div>
			<div id="item23optionalSD">
				<input type="hidden" name="item23Osd" id="item23osdValue">
				<input type="text" class="item_23o item_23" value="<?= $form1701q->item23Osd == 'mixedIncome' ? 'x' : '' ?>">
				<input type="hidden" id="item23Osd" value="osd">
			</div>
			<div id="item24itemizedDeduct">
				<input type="hidden" name="item24Itemized" id="item24itemizedValue">
				<input type="text" class="item_24 item_24i" value="<?= $form1701q->item24Itemized == 'mixedIncome' ? 'x' : '' ?>">
				<input type="hidden" id="item24Itemized" value="itemized">
				
			</div>
			<div id="item24optionalSD">
				<input type="hidden" name="item24Osd" id="item24osdValue">
				<input type="text" class="item_24 item_24o" value="<?= $form1701q->item24Osd == 'mixedIncome' ? 'x' : '' ?>">
				<input type="hidden" id="item24Osd" value="osd">
			</div>
			<div id="item25yes">
				<input type="hidden" name="item25" id="item25Value">
				<input type="text" class="item_25" value="<?= $form1701q->item25 == 'mixedIncome' ? 'x' : '' ?>">
			...
			<!--end profile-->
			<div id="f26a">
				<input type="text" class="formInput isFloat isNumeric" name="iTR1701Q26A" value="<?= setData($form1701q,'iTR1701Q26A') ?>" readonly/>
			</div>
			<div id="f26b">
			...
			<div id="f28b">
				<input type="text" class="formInput isFloat isNumeric" name="iTR1701Q28B" value="<?= setData($form1701q,'iTR1701Q28B') ?>" />
			</div>
			<div id="f29a">
			...
			<div id="f30b">
				<input type="text" class="formInput isFloat isNumeric" name="iTR1701Q30B" value="<?= setData($form1701q,'iTR1701Q30B') ?>" />
			</div>
			<div id="f31a">
				<input type="text" class="formInput isFloat isNumeric" name="iTR1701Q31A" value="<?= setData($form1701q,'iTR1701Q31A') ?>" readonly/>
			</div>
			<div id="f31b">
			...
			<div id="f32b">
				<input type="text" class="formInput isFloat isNumeric" name="iTR1701Q32B" value="<?= setData($form1701q,'iTR1701Q32B') ?>" />
			</div>
			<div id="f33a">
				<input type="text" class="formInput isFloat isNumeric" name="iTR1701Q33A" value="<?= setData($form1701q,'iTR1701Q33A') ?>" readonly/>
			</div>
			<div id="f33b">
			...
			<div id="f34b">
				<input type="text" class="formInput isFloat isNumeric" name="iTR1701Q34B" value="<?= setData($form1701q,'iTR1701Q34B') ?>" />
			</div>
			<div id="f35a">
			...
			<div id="f36b">
				<input type="text" class="formInput isFloat isNumeric" name="iTR1701Q36B" value="<?= setData($form1701q,'iTR1701Q36B') ?>" />
			</div>
			<div id="f37a">
				<input type="text" class="formInput isFloat isNumeric" name="iTR1701Q37A" value="<?= setData($form1701q,'iTR1701Q37A') ?>"/>
			</div>
			<div id="f37b">
				<input type="text" class="formInput isFloat isNumeric" name="iTR1701Q37B" value="<?= setData($form1701q,'iTR1701Q37B') ?>"/>
			</div>
			<div id="f38a">
			...
			<div id="f38g">
				<input type="text" class="formInput isFloat isNumeric" name="iTR1701Q38G" value="<?= setData($form1701q,'iTR1701Q38G') ?>" readonly/>
			</div>
			<div id="f38h">
			...
			<div id="f38n">
				<input type="text" class="formInput isFloat isNumeric" name="iTR1701Q38N" value="<?= setData($form1701q,'iTR1701Q38N') ?>" />
			</div>
			<div id="f39a">
				<input type="text" class="formInput isFloat isNumeric" name="iTR1701Q39A" value="<?= setData($form1701q,'iTR1701Q39A') ?>" readonly/>
			</div>
			<div id="f39b">
				<input type="text" class="formInput isFloat isNumeric" name="iTR1701Q39B" value="<?= setData($form1701q,'iTR1701Q39B') ?>" />
			</div>
			<div id="f40a">
			...
			<div id="f40h">
				<input type="text" class="formInput isFloat isNumeric" name="iTR1701Q40H" value="<?= setData($form1701q,'iTR1701Q40H') ?>" />
			</div>
			<div id="f41a">
				<input type="text" class="formInput isFloat isNumeric" name="iTR1701Q41A" value="<?= setData($form1701q,'iTR1701Q41A') ?>" readonly/>
			</div>
			<div id="f41b">
				<input type="text" class="formInput isFloat isNumeric" name="iTR1701Q41B" value="<?= setData($form1701q,'iTR1701Q41B') ?>" />
			</div>
			<div id="f41c">
				<input type="text" class="formInput isFloat isNumeric" name="iTR1701Q41C" value="<?= setData($form1701q,'iTR1701Q41C') ?>"/>
			</div>
		</div>
		<?php
