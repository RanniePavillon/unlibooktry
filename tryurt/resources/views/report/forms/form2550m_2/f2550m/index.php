...
<div id="background">
	...
	<div class="readonly">
		...
		<div id="inp18a"><input type="text" name="part2Item18A" class="isFloat inp2550m" value="<?= number_format((float) getF2550p1Data($form2550mData,'part2Item18A'),2) ?>" /></div>
		...
		<div id="inp18e"><input type="text" name="part2Item18E" class="isFloat inp2550m" value="<?= number_format((float) getF2550p1Data($form2550mData,'part2Item18E'),2) ?>" /></div>
		...
		<div id="inp18m"><input type="text" name="part2Item18M" class="isFloat inp2550m" value="<?= number_format((float) getF2550p1Data($form2550mData,'part2Item18M'),2) ?>"  /></div>
