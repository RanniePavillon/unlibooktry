...
<div>
	...
	<form class="hidden form2551mHolderForm">
		...
		<div class="buttonHolder itrbutton" style="float:right;">
			...
			<input type="submit" value="" class="buttonstyles"/>
			<input type="button" value="" class="postform2551m buttonstyles2"/>
		</div>
		<div style="clear:both;"></div>
		...
		<div class="gen101Holder">
			<div class="gen101">
				<div class="form2551mHolder divClass" id="divelement">
		...
		<div class="buttonHolder buttonbelow">
			<input type="submit" value="" class="buttonstyles addsavebuttons"/>
			<input type="button" value="" class="postform2551m buttonstyles2 addsavebuttons"/>
		</div>
	</form>
...
<script>
	$(function(){
		...
		$('.generate').click(function(){
			...
			form = '2551m';
			$.post(URL+'report/setBirForm',{'month':month, 'year':year,'form':form})
				.done(function(result){
					if(result != 'failed')
					{
						window.open(result+'?month='+month+'&year='+year, '_blank');
					}
				});
		...
		$('.printPdf2').click(function(){
			...
			window.open(URL + 'report/form2551m/printReport?month=' + month + '&year=' + year + '&clinicId=' + clinicId);
			return false;
		});
