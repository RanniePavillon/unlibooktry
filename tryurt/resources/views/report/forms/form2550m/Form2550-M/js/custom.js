$(function(){
	...
	$('input[name="item1"],' + 
		...
		' input[name="item10"],' +
		' input[name="item7"],' +
		' input[name="part2Item12A"],' +
		' input[name="part2Item18A"],' +
		' input[name="part2Item18E"],' +
		' input[name="part2Item18I"],' +
		' input[name="part2Item18M"],' +
		' input[name="part2Item15"],' +
		' input[name="part2Item15M"],' +
		' input[name="part2Item12B"],' +
		' input[name="part2Item13B"],' +
		' input[name="part2Item16A"],' +
		' input[name="part2Item16B"],' +
		' input[name="part2Item17F"],' +
		' input[name="part2Item18B"],' +
		' input[name="part2Item18D"],' +
		' input[name="part2Item18F"],' +
		' input[name="part2Item18H"],' +
		' input[name="part2Item18J"],' +
		' input[name="part2Item18L"],' +
		' input[name="part2Item18O"],' +
		' input[name="part2Item18P"],' +
		' input[name="part2Item19"],' +
		' input[name="part2Item20F"],' +
		' input[name="part2Item21"],' +
		' input[name="part2Item22"],' +
		' input[name="part2Item23G"],' +
		' input[name="part2Item24"],' +
		' input[name="part2Item25D"],' +
		' input[name="part2Item26"]'
	).prop('readonly',true);
