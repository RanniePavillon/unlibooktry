...
<script>
	$(function(){
		...
		$('.item_24').click(function(){
			...
			if(tempVal == 'yes'){
				$('.item_25').removeClass('hidden');
			}else{
				$('.item_25').addClass('hidden');
			}
		...
		$('select').change(function(){
			...
			$('.item_25 option:selected').each(function(){
				item46 = $(this).val() * 25000;
...
<div id="background">
	...
	<div id="item2yes">
		...
		<input type="text" class="item_2" value="<?= $form1701->amended == 'yes' ? 'x' : '' ?>" />
		<input type="hidden" id="item2" value="yes">
	</div>
	<div id="item2no">
		<input type="text" class="item_2" value="<?= $form1701->amended == 'no' ? 'x' : '' ?>" />
		<input type="hidden" id="item2" value="no">
	</div>
	<div id="item3yes">
		<input type="hidden" name="shortPeriod" id="item3Value">
		<input type="text" class="item_3" value="<?= $form1701->shortPeriod == 'yes' ? 'x' : '' ?>" />
		<input type="hidden" id="item3" value="yes">
	</div>
	<div id="item3no">
		<input type="text" class="item_3" value="<?= $form1701->shortPeriod == 'no' ? 'x' : '' ?>" />
		<input type="hidden" id="item3" value="no">
	</div>
	<div id="item4ATC">
		<input type="hidden" name="alpha" id="item4Value">
		<input type="text" class="item_4 item4choi" value="<?= $form1701->alpha == 'comp' ? 'x' : '' ?>" />
		<input type="hidden" id="item4" value="comp">
	</div>
	<div id="item4CI">
		<input type="text" class="item_4b item4choi" value="<?= $form1701->alpha == 'business' ? 'x' : '' ?>" />
		<input type="hidden" id="item4" value="business">
	</div>
	<div id="item4MI">
		<input type="text" class="item_4 item4choi" value="<?= $form1701->alpha == 'mixed' ? 'x' : '' ?>" />
	...
	<div id="item7SP">
		...
		<input type="text" class="item_7" value="<?= $form1701->taxFiler == 'single' ? 'x' : '' ?>" />
		<input type="hidden" id="item7" value="single">
	</div>
	<div id="item7P">
		<input type="text" class="item_7" value="<?= $form1701->taxFiler == 'prof' ? 'x' : '' ?>" />
		<input type="hidden" id="item7" value="prof">
	</div>
	<div id="item7E">
		<input type="text" class="item_7" value="<?= $form1701->taxFiler == 'estate' ? 'x' : '' ?>" />
		<input type="hidden" id="item7" value="estate">
	</div>
	<div id="item7T">
		<input type="text" class="item_7" value="<?= $form1701->taxFiler == 'trust' ? 'x' : '' ?>" />
	...
	<div id="item14S">
		<input type="hidden" name="civilStatus" id="item14Value">
		<input type="text" class="item_14" value="<?= $form1701->civilStatus == 'single' ? 'x' : '' ?>" />
		<input type="hidden" id="item14" value="single">
	</div>
	<div id="item14M">
		<input type="text" class="item_14" value="<?= $form1701->civilStatus == 'married' ? 'x' : '' ?>" />
		<input type="hidden" id="item14" value="married">
	</div>
	<div id="item14LS">
		<input type="text" class="item_14" value="<?= $form1701->civilStatus == 'separated' ? 'x' : '' ?>" />
		<input type="hidden" id="item14" value="separated">
	</div>
	<div id="item14W">
		<input type="text" class="item_14" value="<?= $form1701->civilStatus == 'widow' ? 'x' : '' ?>" />
		<input type="hidden" id="item14" value="widow">
	</div>
	<div id="item15WI">
		<input type="hidden" name="item15" id="item15Value">
		<input type="text" class="item_15" value="<?= $form1701->item15 == 'with_income' ? 'x' : '' ?>" />
		<input type="hidden" id="item15" value="with_income">
	</div>
	<div id="item15WNO">
		<input type="text" class="item_15" value="<?= $form1701->item15 == 'no_income' ? 'x' : '' ?>" />
		<input type="hidden" id="item15" value="no_income">
	</div>
	<div id="item16FS">
		<input type="hidden" name="item16" id="item16Value">
		<input type="text" class="item_16" value="<?= $form1701->item16 == 'joint' ? 'x' : '' ?>" />
		<input type="hidden" id="item16" value="joint">
	</div>
	<div id="item16SF">
		<input type="text" class="item_16" value="<?= $form1701->item16 == 'separate' ? 'x' : '' ?>" />
	...
	<div id="item20ID">
		<input type="hidden" name="item20" id="item20Value">
		<input type="text" class="item_20" value="<?= $form1701->item20 == 'itemized' ? 'x' : '' ?>" />
		<input type="hidden" id="item20" value="itemized">
	</div>
	<div id="item20OSD">
		<input type="text" class="item_20" value="<?= $form1701->item20 == 'osd' ? 'x' : '' ?>" />
		<input type="hidden" id="item20" value="osd">
	</div>
	<div id="item21C">
		<input type="hidden" name="item21" id="item21Value">
		<input type="text" class="item_21" value="<?= $form1701->item21 == 'cash' ? 'x' : '' ?>" />
		<input type="hidden" id="item21" value="cash">
	</div>
	<div id="item21A">
		<input type="text" class="item_21" value="<?= $form1701->item21 == 'accrual' ? 'x' : '' ?>" />
		<input type="hidden" id="item21" value="accrual">
	</div>	
	<div id="item21O">
		<input type="text" class="item_21" value="<?= $form1701->item21 == 'others' ? 'x' : '' ?>" />
	...
	<div id="item22yes">
		<input type="hidden" name="item22" id="item22Value">
		<input type="text" class="item_22" value="<?= $form1701->item22 == 'yes' ? 'x' : '' ?>" />
		<input type="hidden" id="item22" value="yes">
		
	</div>
	<div id="item22no">
		<input type="text" class="item_22" value="<?= $form1701->item22 == 'no' ? 'x' : '' ?>" />
		<input type="hidden" id="item22" value="no">
	</div>
	<div id="item23yes">
		<input type="hidden" name="item23" id="item23Value">
		<input type="text" class="item_23" value="<?= $form1701->item23 == 'yes' ? 'x' : '' ?>" />
		<input type="hidden" id="item23" value="yes">
	</div>
	<div id="item23no">
		<input type="text" class="item_23" value="<?= $form1701->item23 == 'no' ? 'x' : '' ?>" />
		<input type="hidden" id="item23" value="no">
	</div>
	<div id="item24yes">
		<input type="hidden" name="item24" id="item23Value">
		<input type="text" class="item_24" value="<?= $form1701->item24 == 'yes' ? 'x' : '' ?>" />
		<input type="hidden" id="item24" value="yes">
	</div>
	<div id="item24no">
		<input type="text" class="item_24" value="<?= $form1701->item24 == 'no' ? 'x' : '' ?>" />
		<input type="hidden" id="item24" value="no">
	</div>
	<div id="item25">
		<!--<input type="text" class="item_25" name="pg1Item26" value="<?= setData($form1701,'pg1Item26') ?>" />-->
		<select class="item_25 hidden" name="item25">
				<option value="0">
					0
