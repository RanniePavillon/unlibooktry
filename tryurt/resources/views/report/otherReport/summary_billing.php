...
?>
	...
	<form>
		<div class="monthlyExpensesContbilling monthlyExpensesCont">
			...
			<div class="DFs">
				...
				<div style="clear:both;"></div>
				<div class="lineDividerbilling lineDivider"></div>
			</div>
...
<div class="reportHolderContainer trhidden">
	...
	?>
		<div class="noOutsanding">
			You don't have Summary of Billing.
		</div>
	<?php
	}
	?>
...
<script>
	$(function(){
		...
		$('form').submit(function() {
			...
			$.post(URL + 'report/genSummaryBilling', 
				{
		...
		$('.exportButton').click(function(){
			location = URL + 'report/exportSummaryBilling?from='+$('input[name="startdate"]').val()+'&to='+$('input[name="enddate"]').val();
		});
	...
	$('.viewMode').click(function() {
		...
		window.open(URL + 'report/newtab_summaryBilling?startdate=' + startdate + '&enddate=' + enddate);
	...
	if(!$report){
	?>
		$('.monthlyExpensesContbilling input').prop('disabled',true);
