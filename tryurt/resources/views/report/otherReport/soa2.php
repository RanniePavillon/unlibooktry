		...
		<div class="monthlyExpensesCont">
				...
				<div class="DFs">
					<div style="float:left;">
						<div class="dateDiv2">Date From: <input type="date" class="ButInput" name="startdate" value="<?=date('Y-m-d') ?>"> 
							To: 
							<input type="date" class="ButInput" name="enddate" value="<?= date('Y-m-d') ?>">
