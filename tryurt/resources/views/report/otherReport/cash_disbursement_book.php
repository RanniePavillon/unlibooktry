...
?>
	...
	<form>
		<div class="monthlyExpensesContcdb monthlyExpensesCont">
			...
			<div class="DFs">
				...
				<div style="clear:both;"></div>
				<div class="lineDividercdb lineDivider"></div>
			</div>
...
<script>
	$(function(){
		...
		$('form').submit(function() {
			...
			$.post(URL + 'report/genCashDisbursementBook', 
				{
		...
		$('.exportButton').click(function(){
			location = URL + 'report/exportCashDisbursementBook?from='+$('input[name="startdate"]').val()+'&to='+$('input[name="enddate"]').val();
		});
	...
	$('.viewMode').click(function() {
		...
		window.open(URL + 'report/newtab_cashDisburse?startdate=' + startdate + '&enddate=' + enddate);
	...
	<?php
		if(!$report){
		?>
			$('.monthlyExpensesContcdb input').prop('disabled',true);
