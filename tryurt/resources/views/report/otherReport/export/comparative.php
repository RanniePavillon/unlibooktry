		...
		<div class="balanceSheet">
			...
			<table class="balanceTable">
				...
				<tr>
					...
					<td><?php echo number_format((float) $BS_year['CCE'], 2) ?></td>
				</tr>
				<tr>
					...
					<td><?php echo number_format((float) $BS_year['AR'], 2) ?></td>
				</tr>
				<tr>
					...
					<td><?php echo number_format((float) $BS_year['I'] + $IS_year['PDiscount'], 2) ?></td>
				</tr>
				<tr>
					...
					<td><?php echo number_format((float) $BS_year['OCA'], 2) ?></td>
				</tr>
				<tr>
				...
				<tr class="tdborderline">
					...
					<td><?php echo number_format((float) $totalCurrentAsset_year = $BS_year['CCE'] + $BS_year['AR'] +  $BS_year['I'] + $BS_year['OCA'] + $IS_year['PDiscount'] , 2) ?></td>
				</tr>
				<tr>
					<td style="border-bottom:1px solid #000;"></td>
					<td style="border-bottom:1px solid #000;"></td>
				...
				<tr>
					...
					<td><?php echo number_format((float) $BS_year['LTI'], 2) ?></td>
				</tr>
				<tr>
					...
					<td><?php echo number_format((float) $BS_year['PPE'], 2) ?></td>
				</tr>
				<tr>
					...
					<td><?php echo number_format((float) $BS_year['LTR'], 2) ?></td>
				</tr>
				<tr>
					...
					<td><?php echo number_format((float) $BS_year['IA'], 2) ?></td>
				</tr>
				<tr>
					...
					<td><?php echo number_format((float) $BS_year['OA'], 2) ?></td>
				</tr>
				<tr>
					<td style="padding-top:10px;"></td>
					<td style="padding-top:10px;"></td>
				...
				<tr class="tdborderline">
					...
					<td><?php echo number_format((float) $totalNonCurrent_year = $BS_year['LTI'] + $BS_year['PPE'] + $BS_year['LTR'] + $BS_year['IA'] + $BS_year['OA'], 2) ?></td>
				</tr>
				<tr>
					<td style="border-bottom:1px solid #000;"></td>
					<td style="border-bottom:1px solid #000;"></td>
				...
				<tr class="doubleborder boldstyle">
					...
					<td><b><?php echo number_format((float) $totalAsset_year = $totalCurrentAsset_year + $totalNonCurrent_year, 2) ?></b></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><?php echo number_format((float) $BS_year['AP'], 2) ?></td>
				</tr>
				<tr>
					...
					<td><?php echo number_format((float) $BS_year['AE'], 2) ?></td>
				</tr>
				<tr>
					...
					<td><?php echo number_format((float) $BS_year['ITP'], 2) ?></td>
				</tr>
				<tr>
					...
					<td><?php echo number_format((float) $BS_year['OCL'], 2) ?></td>
				</tr>
				<tr>
					<td style="padding-top:10px;"></td>
					<td style="padding-top:10px;"></td>
				...
				<tr class="tdborderline">
					...
					<td><?php echo number_format((float) $totalCurrentLiabilities_year = $BS_year['AP'] + $BS_year['AE'] + $BS_year['ITP'] + $BS_year['OCL'], 2)?></td>
				</tr>
				<tr>
					<td style="border-bottom:1px solid #000;"></td>
					<td style="border-bottom:1px solid #000;"></td>
				...
				<tr>
					...
					<td><?php echo number_format((float) $BS_year['LTB'], 2) ?></td>
				</tr>
				<tr>
					...
					<td><?php echo number_format((float) $BS_year['DC'], 2) ?></td>
				</tr>
                                <tr>
					...
					<td><?php echo number_format((float) $BS_year['di'], 2) ?></td>
				</tr>
				<tr>
					...
					<td><?php echo number_format((float) $BS_year['OL'], 2) ?></td>
				</tr>
				<tr>
					<td style="padding-top:10px;"></td>
					<td style="padding-top:10px;"></td>
				...
				<tr class="tdborderline">
					...
					<td><?php echo number_format((float) $totalNonCurrentLiability_year = $BS_year['LTB'] + $BS_year['DC'] + $BS_year['OL'] + $BS_year['di'], 2) ?></td>
				</tr>
				<tr>
					<td style="border-bottom:1px solid #000;"></td>
					<td style="border-bottom:1px solid #000;"></td>
				...
				<tr class="boldstyle">
					...
					<td>&#8369;</td>
					<td><b><?php echo number_format((float) $totalliability_before = $totalCurrentLiabilities_before + $totalNonCurrentLiability_before, 2) ?></b></td>
					<td><b><?php echo number_format((float) $totalliability_current = $totalCurrentLiabilities_current + $totalNonCurrentLiability_current, 2) ?></b></td>
					<td><b><?php echo number_format((float) $totalliability_year = $totalCurrentLiabilities_year + $totalNonCurrentLiability_year, 2) ?></b></td>
				</tr>
				<tr>
					<td style="padding-top:30px;"></td>
					<td style="padding-top:30px;"></td>
				...
				<tr>
					...
					<td>&#8369;</td>
					<td>0.00<?php // Controller::getFloat($capital_before) ?></td>
					<td>0.00<?php // Controller::getFloat($capital_current) ?></td>
					<td>0.00<?php // Controller::getFloat($capital_year) ?></td>
				</tr>
				<tr>
					...
					<td><?php echo number_format((float) $netIncomeb4IT_year , 2) ?></td>
				</tr>
				<tr>
					...
					<td><?php echo number_format((float) $BS_year['Drawing'], 2) ?></td>
				</tr>
				<tr>
					<td style="border-bottom:1px solid #000;"></td>
					<td style="border-bottom:1px solid #000;"></td>
				...
				<tr class="boldstyle">
					...
					<td><b><?php echo number_format((float) $totalcapital_year, 2) ?></b></td>
				</tr>
				<tr>
					<td style="border-bottom:1px solid #000;"></td>
					<td style="border-bottom:1px solid #000;"></td>
				...
				<tr class="boldstyle doubleborder">
					...
					<td><b><?php echo number_format((float) ($totalliability_year + $totalcapital_year) , 2) ?></b></td>
				</tr>
				<tr>
					<td style="border-bottom-style:double;"></td>
					<td style="border-bottom-style:double;"></td>
