    ...
    <div class="balanceSheet_holder">
        <div class="fromReg">
            ...
            <table class="balanceTable">
                ...
                <tr>
                    <td>&nbsp &nbsp Deferred Income</td>
                    <td></td>
                ...
                <tr>
                    ...
                    <td>&#8369;</td>
                    <td><input type="text" class="bsInput" value="<?php echo Controller::getFloat($balanceSheet['capital']) ?>" readonly ></td>
                </tr>
                <tr>
...
//                $totalcapital = $capital + $netIncomeb4IT + $balanceSheet['Drawing'];
                  $totalcapital = $netIncomeb4IT + $balanceSheet['Drawing'] + $balanceSheet['capital'];
                ?>
                <tr class="boldstyle">
