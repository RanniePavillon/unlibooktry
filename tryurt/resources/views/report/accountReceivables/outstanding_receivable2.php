		...
		<div class="monthlyExpensesCont">
				...
				<div class="DFs">
					<div style="float:left;">
						<div class="dateDiv2">Date From: <input type="text" class="ButInput dd" name="startdate" id="di" value="<?=date('Y-m-d') ?>"> 
							To: 
							<input type="text" class="ButInput" name="enddate" id="di" value="<?= date('Y-m-d') ?>">
